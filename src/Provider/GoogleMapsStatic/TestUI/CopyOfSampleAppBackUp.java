...
/** @author nazmul idris */
public class CopyOfSampleAppBackUp extends JFrame implements ActionListener,
	...
	public static void main(String[] args) {
		Utils.createInEDT(CopyOfSampleAppBackUp.class);
	}
	...
	private void _setupTask() {
		...
		_task.setTaskHandler(new SimpleTaskHandler<ByteBuffer>() {
			...
			/**
			 * {@link CopyOfSampleAppBackUp#_initHook} adds the task status listener, which
			 * is removed here
			 */
			@Override
		...
		// ======== dialogPane ========
		{
			...
			// ======== contentPanel ========
			{
				...
				// ======== panel1 ========
				{
					...
					panel1.add(LatSlider, new TableLayoutConstraints(2, 0, 2,
					...
					panel1.add(LonSlider, new TableLayoutConstraints(2, 1, 2,
					...
					// ---- ttfLicense ----
					ttfLicense
							.setToolTipText("Enter your own URI for a file to download in the background");
					panel1.add(ttfLicense, new TableLayoutConstraints(1, 2, 1,
					...
					panel1.add(zoomSlider, new TableLayoutConstraints(2, 2, 2,
							2, TableLayoutConstraints.FULL,
							TableLayoutConstraints.FULL));
...
//When the state of the slider is changed, change the text values inside the text fields
	public void stateChanged(ChangeEvent e) {
		...
		ttfLat.setText("" + LatSlider.getDoubleValue());
		ttfLon.setText("" + (LonSlider.getDoubleValue()));
	}
	//Coded by Mark Aronin
		class DecimalSlider extends JSlider{
			public DecimalSlider (int min, int max ){
				super(min*10000, max*10000);
			}
			public double getDoubleValue(){
				return ((double)super.getValue()/10000);
			}
		}
}
